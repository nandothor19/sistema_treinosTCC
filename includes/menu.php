        ...
        <div class="drop-down__menu-box">
            <ul class="drop-down__menu">
                <li class="drop-down__item">
                    <a href="dashboard.php">🏠︎ Dashboard</a>
                </li>
                <li class="drop-down__item">
                ...
                <li class="drop-down__item">
                    <a href="info_usuario.php">📏 Dados do Usuário</a>
                </li>
                <li class="drop-down__item">
                    <a href="visualizaProgresso.php">📈Visualização do Progresso</a>
                </li>
                <li class="drop-down__item">
