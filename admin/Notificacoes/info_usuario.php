...
<div class="w3-container w3-round-xxlarge w3-card-4"
    ...
    <form class="w3-container" action="#" method="post">
        ...
        <div class="w3-section">
            ...
            <input class="w3-input w3-border w3-margin-bottom w3-round-xxlarge" 
                   ...
                   value="<?php isset($cadastroNome) ? $cadastroNome : '' ?>">

            <label style="font-weight: bold;">E-mail</label>
            <input class="w3-input w3-border w3-margin-bottom w3-round-xxlarge" 
                   type="email" name="email" placeholder="Digite seu e-mail"
                   value="<?php isset($cadastroEmail) ? $cadastroEmail : '' ?>">
    ...
    <div class="w3-container w3-section w3-center">
        <a href = "criar_usuario.php" style="color: #e67b39; font-weight: bold;">Cadastrar Novo Usuário</a>
    </div>
